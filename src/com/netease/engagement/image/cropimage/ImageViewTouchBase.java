...
import com.netease.engagement.image.RotateBitmap;
...
public abstract class ImageViewTouchBase extends com.netease.engagement.widget.LoadingImageView {
    ...
    public void zoomToCenter(float scale, float centerX, float centerY) {
        if (scale > mMaxZoom) {
            scale = mMaxZoom;
        }
