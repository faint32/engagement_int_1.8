...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	...
	private int mPinnedHeaderIndex = -2;//
	private OnPinnedHeaderListener mOnPinnedShowListener;
	
	public interface OnPinnedHeaderListener{
		public void onPinnedHeaderShow();
		public void onPinnedHeaderHide();
	}
	
	public void setOnPinnedHeaderListener(OnPinnedHeaderListener listener){
		mOnPinnedShowListener = listener;
	}
	
	public void setPinnedHeaderIndex(int index){
		mPinnedHeaderIndex = index;
	}
    ...
    public final void onScroll(final AbsListView view, final int firstVisibleItem, final int visibleItemCount,
		...
		if(mOnPinnedShowListener != null){
			if(mPinnedHeaderIndex > -2 && firstVisibleItem > mPinnedHeaderIndex){
				mOnPinnedShowListener.onPinnedHeaderShow();
			}else{
				mOnPinnedShowListener.onPinnedHeaderHide();
			}
		}
